...
public class SendingGetRequestToInvoiceDownload {
	...
	String endPoint="ZMOB_SEEDAPP_SRV/InvoicePdfNewSet(InvoiceNumber='1600008169',Year='2024')";
	String token;
	Map<String, String> cookies=CapturingCookie.cookies;
	
	@Test
	public void GetRequestToInvoiceDownload() throws IOException {
