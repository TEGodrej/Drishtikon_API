...
public class SendingGetRequestToSubjectListBC {
	...
	String endPoint="ZMOB_PCRM_DISTRIBUTOR_SRV/BalConfDropdownSet";
	String token;
	Map<String, String> cookies=CapturingCookie.cookies;
	
	@Test
	public void GetRequestToSubjectListBC() throws IOException {
