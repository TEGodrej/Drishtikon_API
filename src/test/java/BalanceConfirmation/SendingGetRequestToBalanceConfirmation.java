...
public class SendingGetRequestToBalanceConfirmation {
	...
	String endPoint="ZMOB_PCRM_DISTRIBUTOR_SRV/BalanceConfirmationSet('2000408')";
	String token;
	Map<String, String> cookies=CapturingCookie.cookies;
	
	@Test
	public void GetRequestToBalanceConfirmation() throws IOException {
