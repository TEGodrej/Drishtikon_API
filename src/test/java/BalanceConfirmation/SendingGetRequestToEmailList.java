...
public class SendingGetRequestToEmailList {
	...
	String endPoint="ZMOB_PCRM_DISTRIBUTOR_SRV/OfficerEmailSet('2018590')";
	String token;
	Map<String, String> cookies=CapturingCookie.cookies;
	
	@Test
	public void GetRequestToEmailList() throws IOException {
