...
public class SendingGetRequestToCustomerCollectionFinanceData {
	...
	String endPoint="ZMOB_PCRM_DISTRIBUTOR_SRV/DrshtikonCustomercollSet?$filter=(CustomerCode eq '2000408')";
	String token;
	Map<String, String> cookies=CapturingCookie.cookies;
	
	
	@Test
	public void GetRequestToCustomerCollectionFinanceData() throws IOException {
