...
public class SendingGetRequestToPaymentList {
	...
	String endPoint="ZMOB_PCRM_DISTRIBUTOR_SRV/DrshtikonCustOpenitemsSet?$filter=(CustomerNo eq '2000408')";
	String token;
	Map<String, String> cookies=CapturingCookie.cookies;
	
	
	@Test
	public void RequestToPaymentList() throws IOException {
